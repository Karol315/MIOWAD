        ...
        for epoch in range(epochs):
            ...
            for i in range(0, n_samples, batch_size):
                ...
                for layer in reversed(self.layers):
                    d_output = layer.backward(d_output, learning_rate, mode=mode, momentum=momentum, decay_rate=decay_rate)

    def fit_with_history(self, X, y, epochs, learning_rate, batch_size=None, mode = "simple", momentum = 0.9, decay_rate = 0.9):
        """
