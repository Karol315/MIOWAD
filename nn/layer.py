...
class Layer:
    ...
    def backward(self, d_output, learning_rate, mode="simple", momentum=0.9, decay_rate=0.9, l2_lambda=0.0):
        ...
        # Mechanizm regularyzacji L2 (Weight Decay)
        if l2_lambda > 0.0:
            d_weights += l2_lambda * self.weights
